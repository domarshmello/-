...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
                ...
                <div class="col-md-12">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form method="post" action="${pageContext.request.contextPath}/teacherAdd.do"
                                  enctype="multipart/form-data">
                                姓名：<input type="text" name="username"><br>

                                系 ：<select name="departmentSelect">
                                <option> - -请 选 择- -</option>
                            </select><br>
                                专业：<select name="majorSelect">
                                <option value=0> - -请 选 择- -</option>
                            </select>
                                <br>
                                <%--专业：<input type="text" name="mMajor"><br>--%>
                                选择照片：<input type="file" name="photo" id="photo"/><br>
                                密码：<input type="password" name="password"><br>
                                <input type="submit" value="提交">
                                <input type="reset" value="重写">
                            </form>
                            <a href="${pageContext.request.contextPath}/teacherList.do">返回教师列表</a>
                        </div>
                    </section>
                    <!--earning graph end-->
                </div>
        ...
        <div class="footer-main">
            <a href="${pageContext.request.contextPath}/admin.action" target="_blank"> 答辩评分系统后台管理中心 -- domian studio</a>
        </div>
    </aside><!-- /.right-side -->
