                            ...
                            <div class="panel-body">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>管理员</td>
                                        <td>wo</td>
                                        <td><span class="badge bg-red">1234</span></td>
                                    </tr>
                                    <tr>
                                        <td>2.</td>
                                        <td>教师</td>
                                        <td>laowang</td>
                                        <td><span class="badge bg-yellow">1234</span></td>
                                    </tr>
                                    <tr>
                                        <td>3.</td>
                                        <td>学生</td>
                                        <td>dumian</td>
                                        <td><span class="badge bg-light-blue">1234</span></td>
                                    </tr>
