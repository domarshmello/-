                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form method="post" action="${pageContext.request.contextPath}/studentUpdate.do">
                                学号：${student.userId}<input type="hidden" name="userId" value="${student.userId}"
                                                           style="color:black"><br>
                                姓名：<input type="text" name="username" value="${student.username}"><br>
