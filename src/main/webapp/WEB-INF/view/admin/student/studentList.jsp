                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img width="600" height="400"
                                                 src="${pageContext.request.contextPath}/studentPhoto.do?id=${student.studentNo}&photoPath=${student.photoPath}">
                                        </td>
                                        <td>
                                            <a href="${pageContext.request.contextPath}/studentUpdateView.do?userId=${student.userId}">修改</a>
                                            <a href="${pageContext.request.contextPath}/studentDelete.do?userId=${student.userId}">删除</a>
                                            <a href="${pageContext.request.contextPath}/studentAddView.do">添加</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
