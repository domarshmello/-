                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                            ...
                            <sec:authorize access="hasAuthority('TEACHER')">
                                <div class="panel-body">
                                    ...
                                    <table border="1" align="center">
                                        <form method="post" action="${pageContext.request.contextPath}/defenseAdd.do"
                                              enctype="multipart/form-data">
                                            答辩主题：<select name="defenseSubject">
                                            <c:forEach items="${subjects}" var="sub">
                                                <option value="${sub.subId}">${sub.subName}</option>
                                            </c:forEach>
                                        </select><br>
                                            答辩学生：<select name="defenseStudent">
                                            <c:forEach items="${students}" var="stu">
                                                <option value="${stu.userId}">${stu.username}</option>
                                            </c:forEach>
                                        </select><br>
                                            答辩时间：<input type="text" name="defenseTime"><br>
                                            答辩地点：<input type="text" name="defenseLocation"><br>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel">
                                    <a href="#" style="background:url(/images/bg4.jpg)"></a>
