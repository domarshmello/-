                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        <header class="panel-heading">
                            <span class="pull-right label label-info inline m-t-15">答辩负责教师</span>教师列表
                        </header>

                        <ul class="list-group teammates">
                            <li class="list-group-item">
                                <%--<sec:authorize access="hasAuthority('TEACHER')+('ADMIN')">--%>
                                <div class="panel-body">
                                    <table border="1">
                                        <tr>
                                            <th>编号</th>
                                        ...
                                        <c:forEach items="${teachers}" var="teacher">
                                            <tr>
                                                ...
                                                <td>
                                                        <%--<img src="admin/${teacher.photoPath}" width="50" height="50" width="50" height="50"></a>--%>
                                                    <img src="admin/img/26115.jpg" width="50" height="50" width="50"
                                                         height="50"></a>
                                                </td>
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/teacherUpdateView.do?userId=${teacher.userId}">修改</a>
                                                    <a href="${pageContext.request.contextPath}/teacherDelete.do?userId=${teacher.userId}">删除</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </table>
