            ...
            <div class="row" style="margin-bottom:5px;">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">答辩主题列表</li>
                    </ul>


                    <div class="panel">
                        <header class="panel-heading">
                            <span class="pull-right label label-info inline m-t-15"> 列表 </span>答辩主题
                        </header>
                                ...
                                <div class="panel-body">
                                    ...
                                    <table border="1" align="center">
                                        ...
                                        <c:forEach items="${subjects}" var="subject">
                                            <tr>
                                                <td>${subject.subId}</td>
                                                <td>${subject.deparId}</td>
                                                <td>${subject.subName}</td>
                                                <td>${subject.submount}</td>
                                                <td>${subject.subSelected}</td>
                                                <td>${subject.subPalce}</td>
                                                <td>${subject.subDetail}</td>
                                                <td>${subject.subDesc}</td>

                                                <td>
                                                    <a href="${pageContext.request.contextPath}/subjectUpdateView.do?subId=${subject.subId}">修改</a>
                                                    <a href="${pageContext.request.contextPath}/subjectDelete.do?subId=${subject.subId}">删除</a>
                                                </td>
                                            </tr>
                        ...
                        <div class="panel-footer bg-white">
                            ...
                            <button class="btn btn-primary btn-addon btn-sm">
                                ...
                                <a href="${pageContext.request.contextPath}/subjectAddView.do"
                                   style="color:black"> 添加答辩主题 </a>
