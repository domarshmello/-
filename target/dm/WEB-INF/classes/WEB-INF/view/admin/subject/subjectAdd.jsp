                ...
                <div class="col-md-12">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form method="post" action="${pageContext.request.contextPath}/subjectAdd.do"
                                  enctype="multipart/form-data">
                                辩题名 ：<input type="text" name="subName"><br>
                                辩题描述：<input type="text" name="subDesc"><br>
                                <br>
                            ...
                            <a href="${pageContext.request.contextPath}/SubjectList.action">返回答辩主题列表</a>
                        </div>
                    </section>
                    <!--earning graph end-->
                </div>
