            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form method="post" action="${pageContext.request.contextPath}/teacherUpdate.do">
                                编号：${teacher.userId}<input type="hidden" name="userId" value="${teacher.userId}"
                                                           style="color:black"><br>
                                姓名：<input type="text" name="username" value="${teacher.username}"><br>
                                专业：<input type="text" name="major" value="${teacher.major}"><br>
                                <input type="submit" value="提交">
                                <input type="reset" value="重写">
                            </form>
                            <a href="${pageContext.request.contextPath}/teacherList.do">教师列表</a>
                        </div>
                    </section>
                    <!--earning graph end-->
                </div>
