...
<head>
    ...
    <%--点击评分时  弹出模态框 输入数据发送 服务器端  js点击评分时 重新reload刷新--%>

    <script>
        $(document).ready(function () {
            $('#inputScore_btn').click(function () {
                $.post("/inputDefenseScore.do",
                    {
                        id: $('#selectedDefense').val(),
                        score: $('#inputtedScore').val()
                    },
                    function (result) {
...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <table border="1">
                                ...
                                <c:forEach items="${defenses}" var="d">
                                    <tr>
                                        <td>${d.id}</td>
                                        <td>${d.subjectName}</td>
                                        <td>${d.studentName}</td>
                                        ...
                                        <td>${d.status}</td>
                                        <td>
                                            <c:if test="${d.status == '未评分'}">
                                                <a href="#inputScoreDialog" data-toggle="modal"
                                                   onclick="$('#selectedDefense').val(${d.id})">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <%--评分模态框--%>
                            <input type="hidden" id="selectedDefense">
                            <sec:authorize access="hasAuthority('TEACHER')">
                                <div class="modal fade bs-example-modal-sm" id="inputScoreDialog" role="dialog"
                                    ...
                                    <div class="modal-dialog  modal-sm">
                                        <div class="modal-content" align="center">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabelf" align="center">输入成绩</h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label class="control-label">成绩</label>
                                                    <input type="text" class="form-control" id="inputtedScore"/>
                                                </div>
                                            </div>
                                            <!-- 弹出会话框的底部两个按钮 注册 关闭 -->
                                            <div class="modal-footer">
                                                <button class="btn btn-primary" type="button" id="inputScore_btn">
                                                    确 定
                                                </button>
        ...
        <div class="footer-main">
            <a href="#" target="_blank"> 答辩评分系统后台管理中心 -- domian studio</a>
        </div>
    </aside><!-- /.right-side -->
